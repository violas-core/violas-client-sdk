...
#echo $stdlib
# stdlib = 
(ls ~/Projects/work/Violas/language/diem-framework/modules/*.move && ls ~/Projects/work/Violas/language/move-stdlib/modules/*.move) | xargs ~/Projects/work/Violas/target/release/move-build $1 -d $2 $3 $4 $5
