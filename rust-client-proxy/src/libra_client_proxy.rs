...
use libra_types::{
    ...
    account_config::{
        ...
        type_tag_for_currency_code, //BalanceResource,
...
impl ClientProxy {
    ...
    pub fn new(
        ...
        let tc_account = if libra_root_account_file.is_empty() {
            None
        } else {
        ...
        Ok(ClientProxy {
            ...
            treasury_compliance_account: tc_account,
