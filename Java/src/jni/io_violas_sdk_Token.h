 ...
 */
JNIEXPORT jlong JNICALL Java_io_violas_sdk_Token_nativeCreateToken
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_io_violas_sdk_Token_nativeGetBalance__JJ
  (JNIEnv *, jobject, jlong, jlong);
 ...
 * Signature: (J[B)J
 */
JNIEXPORT jlong JNICALL Java_io_violas_sdk_Token_nativeGetBalance__J_3B
