 ...
 * Signature: (J)V
 */
	JNIEXPORT void JNICALL Java_io_violas_sdk_Client_destroyNativeClient(JNIEnv *env, jobject obj, jlong native_client)
	{
 ...
 * Signature: (J)V
 */
	JNIEXPORT void JNICALL CLASS_METHOD(native_1test_1validator_1connection)(JNIEnv *env, jobject obj, jlong native_client)
	{
 ...
 */
	JNIEXPORT jobject JNICALL CLASS_METHOD(nativeCreateNextAccount)(JNIEnv *env, jobject obj, jlong native_client)
	{
 ...
 */
	JNIEXPORT jobjectArray JNICALL CLASS_METHOD(nativeGetAllAccounts)(JNIEnv *env, jobject obj, jlong native_client)
	{
 ...
 * Signature: (JJ)D
 */
	JNIEXPORT jdouble JNICALL CLASS_METHOD(nativeGetBalance__JJ)(JNIEnv *env, jobject obj, jlong native_client, jlong account_index)
	{
 ...
 * Signature: (J[B)D
 */
	JNIEXPORT jdouble JNICALL CLASS_METHOD(nativeGetBalance__J_3B)(JNIEnv *env, jobject obj, jlong native_client, jbyteArray address)
	{
 ...
 * Signature: (JJ)J
 */
	JNIEXPORT jlong JNICALL CLASS_METHOD(nativeGetSequenceNumber)(JNIEnv *env, jobject obj, jlong native_client, jlong account_index)
	{
 ...
 * Signature: (JJJZ)V
 */
	JNIEXPORT void JNICALL CLASS_METHOD(nativeMint)(JNIEnv *env, jobject obj, jlong native_client, jlong account_index, jlong amount,
 ...
 */
	JNIEXPORT void JNICALL
		CLASS_METHOD(nativeCompile__JJLjava_lang_String_2ZLjava_lang_String_2)(JNIEnv *env, jobject obj, jlong native_client, jlong account_index, jstring script_file_name, jboolean is_module, jstring temp_path)
	{
 ...
 */
	JNIEXPORT void JNICALL
		CLASS_METHOD(nativeCompile__J_3BLjava_lang_String_2ZLjava_lang_String_2)(JNIEnv *env, jobject obj, jlong native_client, jbyteArray address, jstring script_file_name, jboolean is_module, jstring temp_path)
	{
 ...
 */
	JNIEXPORT void JNICALL CLASS_METHOD(nativePublishModule)(JNIEnv *env, jobject obj, jlong native_client, jlong account_index, jstring module_file_name)
	{
 ...
 */
	JNIEXPORT void JNICALL CLASS_METHOD(nativeExecuteScript)(JNIEnv *env, jobject obj, jlong native_client, jlong account_index, jstring script_file_name, jobjectArray args)
	{
 ...
 */
	JNIEXPORT jobject JNICALL CLASS_METHOD(nativeGetCommittedTxnsByAccSeq)(JNIEnv *env, jobject obj, jlong native_client, jlong account_index, jlong sequence_number)
	{
 ...
 */
	JNIEXPORT jobjectArray JNICALL CLASS_METHOD(nativeGetCommitedTxnbyRange)(JNIEnv *env, jobject obj, jlong native_client, jlong start_version, jlong limit, jboolean is_fatch_event)
	{
